      ...
      <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
        ...
        <div style="width:80%; padding-top:70px" >
            <div class="row m-2 mt-3 ms-3">
              ...
              <div class="container card col-2 m-1 text-center m-2 position-relative">
                ...
                <a class="text-decoration-none " href="album/{{ $data->id }}" style="color: black">
                  <div class="card-img-top mt-4"><img src="{{ asset('mylogo.jpeg') }}" width="70px" style="border-radius: 50%"></i></div>
                 @php
